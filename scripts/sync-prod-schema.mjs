...
datasource db {
  // Pooled (Application-Runtime) und Unpooled (Migrate) Connection-URLs
  // sind in Prisma 7 nicht mehr im Schema, sondern in prisma.config.ts
  // bzw. werden vom Driver-Adapter zur Laufzeit aus DATABASE_URL gelesen.
  provider = "postgresql"
}
`;
